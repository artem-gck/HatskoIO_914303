...
namespace StructureServiceApi.MapperProfiles
{
    public class ControllerProfile : Profile
    {
        public ControllerProfile()
        {
            ...
            CreateMap<User, DepartmentUnitResponce>().ForMember(dto => dto.Department, memb => memb.MapFrom(ent => ent.Department.Name))
            ...
            CreateMap<DepartmentUnitResponce, User>().ForMember(ent => ent.Department, memb => memb.MapFrom(dto => new DepartmentEntity { Name = dto.Department, CheifUserId = dto.CheifUserId }))
